...
\usepackage{amsmath, amsthm, amssymb, amsfonts, tikz, caption, subcaption, python, program, geometry}
\usepackage{pgfplots}
...
\newgeometry{bottom=1in, top=1in, right=1in, left=1in}
...
\section{Background}
\label{S:2}
\input{Sections/Stereo.tex}
\input{Sections/SFM.tex}
